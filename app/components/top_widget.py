...
class TopWidget(QFrame):
    ...
    def top_frame(self):
        ...
        frame.setMinimumHeight(87)

        # لایه اصلی برای فریم بالایی
        title_layout = QHBoxLayout(frame)
        title_layout.setContentsMargins(0, 0, 0, 0)
        title_layout.setSpacing(10)

        # عنوان
        self.title_lb = QLabel(self.title, frame)
        self.semi_title = QLabel(self.sub_title, frame)

        # راست
        right_layout = QHBoxLayout()
        right_layout.setAlignment(Qt.AlignmentFlag.AlignRight)
        right_layout.addWidget(self.semi_title)
        ...
        left_layout.addWidget(self.out_btn)
        left_layout.addWidget(self.notifi_btn)
    ...
    def Label_UI(self):
        ...
        self.search_lb.move(
            self.search_line.width() - 25,
            (self.search_line.height() - 14) // 2
        )
